...
export default function DataSyncPage() {
  ...
  useEffect(() => {
    ...
    if (success === 'connected') {
      ...
      // Clear URL params without causing re-render loop
      window.history.replaceState({}, '', '/settings/data-sync');
    } else if (error) {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 pb-24">
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800 dark:text-white">データ連携</h1>
        ...
        {/* Health Connect Section - Always visible */}
